/* =========================================================
   SISTEMA DE MUEBLERÍA IA - Versión Maestro Integrada (Final V5.8)
   - Fix: Expanded size synonyms (Supports "estandar", "media", "grando", "grandos", etc.)
...
async function moduloCatalogo(message, contact, env, trace, forcingCat = null) {
  ...
  // V5.8: Expanded synonyms and plural support
